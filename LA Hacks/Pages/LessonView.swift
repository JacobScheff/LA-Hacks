...
private func lessonFor(node: StarNode) -> LessonContent {
    ...
    case "coins":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("Which group equals exactly 50¢?", choices: ["1 quarter + 2 dimes","2 quarters","4 dimes + 2 nickels","All of the above"], answer: "All of the above", hint: "Check each: Q+2D=45¢, 2Q=50¢, 4D+2N=50¢ — wait, 1Q+2D=45, not 50!"),
            ]
        )
    case "change":
        return LessonContent(
    ...
    case "dollar":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("$3.99 + $2.01 = ?", choices: ["$5.00","$6.00","$5.99","$4.00"], answer: "$6.00", hint: "$3.99 rounds to $4, $2.01 rounds to $2 → $6. Or add exactly: 3.99+2.01=6.00."),
    ...
    case "cycle":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("How is a plant's life cycle similar to an animal's?", choices: ["Plants don't have life cycles","Both start from a seed","Both start from an egg","Both have a larva stage"], answer: "Both start from a seed", hint: "Wait — plants start from seeds, animals usually from eggs. Actually they both start as a single 'starter unit.'"),
            ]
        )
    case "eco":
        return LessonContent(
    ...
    case "sun":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("What causes the Moon's phases (new moon, full moon, etc.)?", choices: ["Earth's shadow always covers the Moon","The Moon changing size","The Moon's position relative to Earth and Sun","Clouds covering the Moon"], answer: "The Moon's position relative to Earth and Sun", hint: "We see different lit portions of the Moon as it orbits Earth."),
            ]
        )
    case "season":
        return LessonContent(
            ...
            problems: [
                .mc("What causes seasons on Earth?", choices: ["Earth's distance from the Sun","Earth's tilted axis and position in its orbit","The Moon's gravity","The amount of rain"], answer: "Earth's tilted axis and position in its orbit", hint: "It's about TILT, not distance — Earth is actually closest to the Sun in winter (Northern Hemisphere)!"),
    ...
    case "weather":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("Cumulus clouds look like fluffy white puffs. Cumulonimbus clouds bring…", choices: ["Clear skies","Light drizzle","Thunderstorms","Snow only"], answer: "Thunderstorms", hint: "Cumulonimbus = towering storm clouds that bring thunder and lightning!"),
                ...
                .input("Water falling from clouds is called precipitation. Name one type of precipitation.", answer: "rain", hint: "Rain, snow, sleet, and hail are all types of precipitation."),
            ]
        )
    case "water":
        return LessonContent(
    ...
    case "rocks":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("Marble is limestone that was changed by extreme heat and pressure underground. Marble is…", choices: ["Igneous","Sedimentary","Metamorphic","Volcanic"], answer: "Metamorphic", hint: "Meta = change. Heat and pressure transform the rock."),
    ...
    case "ancient":
        return LessonContent(
            ...
            problems: [
                .mc("Ancient Mesopotamia (modern-day Iraq) is often called…", choices: ["The Land Down Under","The Cradle of Civilization","The New World","The Middle Kingdom"], answer: "The Cradle of Civilization", hint: "Mesopotamia was one of the earliest places humans formed cities and writing."),
                ...
                .mc("The ancient Silk Road was a trade route connecting…", choices: ["Europe and Africa","China and Europe/Middle East","North and South America","Egypt and Greece"], answer: "China and Europe/Middle East", hint: "Traders traveled the Silk Road carrying silk, spices, and ideas between East and West."),
            ]
        )
    case "rastaban":
        return LessonContent(
            intro: "SKY STORIES (myths) are tales ancient cultures told to explain the stars! Every constellation has a legend — from Greek heroes to Native American teachings. The stars were their calendar and compass! ✨",
            ...
            problems: [
                ...
                .mc("An 'origin myth' explains…", choices: ["How to navigate by stars","How something came to exist or began","The distance to a star","A historical battle"], answer: "How something came to exist or began", hint: "Origin myths = stories explaining how the world, animals, or phenomena were created."),
            ]
        )
    case "maps":
        return LessonContent(
    ...
    case "nu":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("BCE (Before Common Era) years count BACKWARD. Which is earlier: 500 BCE or 200 BCE?", choices: ["500 BCE","200 BCE","Same time"], answer: "500 BCE", hint: "BCE counts backward: 500 BCE is further back in time than 200 BCE."),
                .mc("On a timeline, what does an arrow at the right end usually mean?", choices: ["The timeline is complete","Time continues beyond what's shown","The last event was important","Nothing"], answer: "Time continues beyond what's shown", hint: "Arrows show that time keeps going — the timeline doesn't capture everything!"),
            ]
        )
    case "native":
        return LessonContent(
            ...
            problems: [
                ...
                .mc("Many Native nations were forced to relocate in the 1800s. This period included the forced marches known as…", choices: ["The Oregon Trail","The Trail of Tears","The Santa Fe Trail","The Silk Road"], answer: "The Trail of Tears", hint: "The Trail of Tears was the forced removal of Cherokee and other nations from their homelands."),
    ...
    case "explor":
        return LessonContent(
            ...
            problems: [
                .mc("Ferdinand Magellan's expedition was the first to…", choices: ["Reach Asia","Sail around (circumnavigate) the entire Earth","Find the Americas","Discover Australia"], answer: "Sail around (circumnavigate) the entire Earth", hint: "Magellan's voyage (1519–1522) was the first to circle the globe."),
    ...
    case "rev":
        return LessonContent(
            ...
            problems: [
                .mc("What famous phrase from the Declaration of Independence says people have rights to 'Life, Liberty, and the pursuit of Happiness'?", choices: ["The Preamble to the Constitution","The Bill of Rights","The Declaration of Independence","The Magna Carta"], answer: "The Declaration of Independence", hint: "Thomas Jefferson wrote those powerful words in the Declaration of Independence."),
                .mc("Who was the commander of the Continental Army during the Revolution?", choices: ["Thomas Jefferson","John Adams","Benjamin Franklin","George Washington"], answer: "George Washington", hint: "Washington led the Continental Army — and later became the first president."),
    ...
    private func sendNovaAI(userQuery: String, then: (() -> Void)? = nil) {
        ...
        RAGPipeline.run(
            ...
            onComplete: { result in
                DispatchQueue.main.async {
                    let responseText = result.text.isEmpty
                        ? "Hmm, I had a little trouble thinking there! Let's keep going. 🚀"
                        : result.text
                    withAnimation(.easeOut(duration: 0.15)) {
                        isTyping = false
