...
enum GalaxyData {
    ...
    static let constellations: [Constellation] = [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "count", label: "Counting",     star: "Dubhe",  emoji: "👆", x: 360, y: 240, status: .mastered, size: 7, mastery: nil),
                StarNode(id: "place", label: "Place Value",  star: "Merak",  emoji: "🏠", x: 350, y: 310, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "add",   label: "Adding",       star: "Phecda", emoji: "➕", x: 290, y: 320, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "sub",   label: "Subtracting",  star: "Megrez", emoji: "➖", x: 280, y: 270, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "mul",   label: "Times Tables", star: "Alioth", emoji: "✖️", x: 220, y: 260, status: .mastered, size: 7, mastery: nil),
                StarNode(id: "div",   label: "Sharing (÷)",  star: "Mizar",  emoji: "➗", x: 165, y: 245, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "odd",   label: "Odd & Even",   star: "Alkaid", emoji: "👯", x: 110, y: 220, status: .mastered, size: 6, mastery: nil),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "half",     label: "Halves & Quarters",  star: "Betelgeuse", emoji: "🍰", x: 670, y: 250, status: .mastered, size: 7, mastery: nil),
                StarNode(id: "frac",     label: "Reading Fractions",  star: "Bellatrix",  emoji: "📖", x: 540, y: 260, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "equiv",    label: "Equal Fractions",    star: "Alnitak",    emoji: "🟰", x: 660, y: 340, status: .learning, size: 5, mastery: 0.65),
                StarNode(id: "compare",  label: "Bigger or Smaller?", star: "Alnilam",    emoji: "⚖️", x: 600, y: 340, status: .learning, size: 6, mastery: 0.5),
                StarNode(id: "addfrac",  label: "Adding Slices",      star: "Mintaka",    emoji: "🍕", x: 540, y: 340, status: .gap,      size: 5, mastery: 0.28),
                StarNode(id: "mixed",    label: "Mixed Numbers",      star: "Hatysa",     emoji: "🥧", x: 600, y: 400, status: .gap,      size: 4, mastery: 0.18),
                StarNode(id: "simplify", label: "Simplifying",        star: "Saiph",      emoji: "✂️", x: 670, y: 460, status: .gap,      size: 5, mastery: 0.22),
                StarNode(id: "word",     label: "Word Problems",      star: "Rigel",      emoji: "🧩", x: 530, y: 470, status: .locked,   size: 7, mastery: nil),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "tri",   label: "Triangles", star: "Caph",      emoji: "🔺", x: 130, y: 540, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "sq",    label: "Squares",   star: "Schedar",   emoji: "🟦", x: 180, y: 620, status: .mastered, size: 7, mastery: nil),
                StarNode(id: "circ",  label: "Circles",   star: "Gamma Cas", emoji: "⭕", x: 235, y: 540, status: .mastered, size: 7, mastery: nil),
                StarNode(id: "poly",  label: "Polygons",  star: "Ruchbah",   emoji: "🔶", x: 290, y: 620, status: .learning, size: 6, mastery: 0.7),
                StarNode(id: "sym",   label: "Symmetry",  star: "Segin",     emoji: "🦋", x: 345, y: 555, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "angle", label: "Angles",    star: "Achird",    emoji: "📐", x: 220, y: 700, status: .learning, size: 4, mastery: 0.55),
                StarNode(id: "area",  label: "Area",      star: "Marfak",    emoji: "🟩", x: 130, y: 700, status: .gap,      size: 4, mastery: 0.3),
                StarNode(id: "vol",   label: "Volume",    star: "Fulu",      emoji: "🧊", x: 320, y: 720, status: .gap,      size: 4, mastery: 0.2),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "clock",    label: "Reading Clocks",  star: "Regulus",     emoji: "🕒", x: 700, y: 620, status: .mastered, size: 8, mastery: nil),
                StarNode(id: "min",      label: "Hours & Minutes", star: "Eta Leonis",  emoji: "⏱️", x: 700, y: 560, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "cal",      label: "Calendar",        star: "Algieba",     emoji: "📅", x: 720, y: 510, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "elapsed",  label: "How Long?",       star: "Adhafera",    emoji: "⌛", x: 760, y: 470, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "rasalas",  label: "AM vs PM",        star: "Rasalas",     emoji: "🌗", x: 800, y: 480, status: .mastered, size: 4, mastery: nil),
                StarNode(id: "algenubi", label: "Time Words",      star: "Algenubi",    emoji: "💬", x: 815, y: 530, status: .mastered, size: 4, mastery: nil),
                StarNode(id: "coins",    label: "Coins",           star: "Chertan",     emoji: "🪙", x: 800, y: 640, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "change",   label: "Making Change",   star: "Zosma",       emoji: "💱", x: 820, y: 600, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "dollar",   label: "Dollars & Cents", star: "Denebola",    emoji: "💵", x: 880, y: 670, status: .mastered, size: 7, mastery: nil),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "phon",    label: "Phonics",         star: "Vega",          emoji: "🔤", x: 220, y: 850,  status: .mastered, size: 9, mastery: nil),
                StarNode(id: "sight",   label: "Sight Words",     star: "Epsilon Lyrae", emoji: "👀", x: 270, y: 880,  status: .mastered, size: 5, mastery: nil),
                StarNode(id: "flu",     label: "Smooth Reading",  star: "Zeta Lyrae",    emoji: "🌊", x: 170, y: 900,  status: .mastered, size: 5, mastery: nil),
                StarNode(id: "main",    label: "Main Idea",       star: "Sheliak",       emoji: "💡", x: 175, y: 970,  status: .learning, size: 6, mastery: 0.6),
                StarNode(id: "detail",  label: "Key Details",     star: "Sulafat",       emoji: "🔍", x: 290, y: 990,  status: .learning, size: 6, mastery: 0.55),
                StarNode(id: "infer",   label: "Reading Clues",   star: "Delta Lyrae",   emoji: "🕵️", x: 270, y: 1050, status: .gap,      size: 5, mastery: 0.3),
                StarNode(id: "theme",   label: "Theme",           star: "Aladfar",       emoji: "🎭", x: 155, y: 1030, status: .gap,      size: 4, mastery: 0.2),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "caps",  label: "Caps & Periods",  star: "Deneb",     emoji: "🔠", x: 540, y: 820,  status: .mastered, size: 8, mastery: nil),
                StarNode(id: "noun",  label: "Nouns & Verbs",   star: "Sadr",      emoji: "🐶", x: 540, y: 920,  status: .mastered, size: 7, mastery: nil),
                StarNode(id: "sent",  label: "Full Sentences",  star: "Albireo",   emoji: "📝", x: 540, y: 1030, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "adj",   label: "Adjectives",      star: "Gienah",    emoji: "🌈", x: 460, y: 920,  status: .learning, size: 6, mastery: 0.6),
                StarNode(id: "para",  label: "Paragraphs",      star: "Delta Cyg", emoji: "📄", x: 620, y: 920,  status: .learning, size: 6, mastery: 0.55),
                StarNode(id: "story", label: "Story Building",  star: "Aljanah",   emoji: "🏰", x: 410, y: 870,  status: .gap,      size: 5, mastery: 0.25),
                StarNode(id: "opin",  label: "My Opinion",      star: "Iota Cyg",  emoji: "💭", x: 660, y: 870,  status: .gap,      size: 4, mastery: 0.2),
                StarNode(id: "edit",  label: "Editing",         star: "Kappa Cyg", emoji: "🧹", x: 480, y: 1000, status: .gap,      size: 4, mastery: 0.15),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "living",  label: "Living vs Not",  star: "Graffias",    emoji: "🌱", x: 720, y: 150, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "plant",   label: "Plant Parts",    star: "Dschubba",    emoji: "🌻", x: 780, y: 175, status: .mastered, size: 6, mastery: nil),
                StarNode(id: "animal",  label: "Animal Groups",  star: "Pi Sco",      emoji: "🦁", x: 840, y: 165, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "habitat", label: "Habitats",       star: "Antares",     emoji: "🌳", x: 800, y: 260, status: .learning, size: 9, mastery: 0.7),
                StarNode(id: "food",    label: "Food Chains",    star: "Sigma Sco",   emoji: "🦊", x: 740, y: 290, status: .learning, size: 5, mastery: 0.55),
                StarNode(id: "cycle",   label: "Life Cycles",    star: "Tau Sco",     emoji: "🦋", x: 830, y: 330, status: .gap,      size: 5, mastery: 0.3),
                StarNode(id: "eco",     label: "Ecosystems",     star: "Epsilon Sco", emoji: "🐝", x: 870, y: 390, status: .gap,      size: 5, mastery: 0.2),
                StarNode(id: "photo",   label: "Photosynthesis", star: "Mu Sco",      emoji: "☀️", x: 900, y: 450, status: .locked,   size: 4, mastery: nil),
                StarNode(id: "zeta",    label: "Cells",          star: "Zeta Sco",    emoji: "🔬", x: 880, y: 510, status: .locked,   size: 5, mastery: nil),
                StarNode(id: "shaula",  label: "Adaptations",    star: "Shaula",      emoji: "🐾", x: 820, y: 540, status: .locked,   size: 7, mastery: nil),
                StarNode(id: "lesath",  label: "Stinger Facts",  star: "Lesath",      emoji: "⚡", x: 800, y: 510, status: .locked,   size: 4, mastery: nil),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "sun",     label: "Sun, Earth, Moon", star: "Polaris",     emoji: "🌞", x: 720, y: 920,  status: .mastered, size: 8, mastery: nil),
                StarNode(id: "season",  label: "Seasons",          star: "Yildun",      emoji: "🍁", x: 770, y: 950,  status: .learning, size: 5, mastery: 0.6),
                StarNode(id: "weather", label: "Weather",          star: "Epsilon UMi", emoji: "⛅", x: 820, y: 985,  status: .learning, size: 5, mastery: 0.65),
                StarNode(id: "water",   label: "Water Cycle",      star: "Zeta UMi",    emoji: "💧", x: 840, y: 1030, status: .gap,      size: 5, mastery: 0.3),
                StarNode(id: "rocks",   label: "Rocks & Minerals", star: "Eta UMi",     emoji: "🪨", x: 900, y: 1040, status: .gap,      size: 4, mastery: 0.2),
                StarNode(id: "planet",  label: "Planets",          star: "Pherkad",     emoji: "🪐", x: 920, y: 1100, status: .gap,      size: 6, mastery: 0.25),
                StarNode(id: "gravity", label: "Gravity",          star: "Kochab",      emoji: "🍎", x: 850, y: 1140, status: .locked,   size: 7, mastery: nil),
                StarNode(id: "galaxy",  label: "Stars & Galaxies", star: "Zeta UMi B",  emoji: "🌌", x: 780, y: 1080, status: .locked,   size: 4, mastery: nil),
            ],
            edges: [
        ...
        Constellation(
            ...
            nodes: [
                StarNode(id: "ancient",  label: "Ancient Peoples",  star: "Eltanin",      emoji: "🏛️", x: 350, y: 1100, status: .mastered, size: 7, mastery: nil),
                StarNode(id: "rastaban", label: "Sky Stories",      star: "Rastaban",     emoji: "✨",  x: 320, y: 1140, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "maps",     label: "Reading Maps",     star: "Grumium",      emoji: "🧭", x: 380, y: 1140, status: .mastered, size: 5, mastery: nil),
                StarNode(id: "nu",       label: "Time Lines",       star: "Nu Draconis",  emoji: "📜", x: 350, y: 1160, status: .mastered, size: 4, mastery: nil),
                StarNode(id: "native",   label: "Native Peoples",   star: "Altais",       emoji: "🪶", x: 420, y: 1190, status: .learning, size: 6, mastery: 0.6),
                StarNode(id: "explor",   label: "Explorers",        star: "Aldhibah",     emoji: "⛵", x: 480, y: 1230, status: .learning, size: 5, mastery: 0.55),
                StarNode(id: "colony",   label: "Long-Ago Towns",   star: "Edasich",      emoji: "🏘️", x: 540, y: 1260, status: .gap,      size: 5, mastery: 0.3),
                StarNode(id: "rev",      label: "Big Changes",      star: "Thuban",       emoji: "🔔", x: 580, y: 1310, status: .gap,      size: 6, mastery: 0.2),
                StarNode(id: "gov",      label: "How Gov Works",    star: "Kappa Dra",    emoji: "🏛️", x: 540, y: 1360, status: .gap,      size: 4, mastery: 0.25),
                StarNode(id: "civil",    label: "Fairness for All", star: "Giausar",      emoji: "🤝", x: 460, y: 1380, status: .locked,   size: 4, mastery: nil),
                StarNode(id: "tail",     label: "Stories Today",    star: "Tail of Draco",emoji: "📰", x: 400, y: 1340, status: .locked,   size: 4, mastery: nil),
            ],
            edges: [
